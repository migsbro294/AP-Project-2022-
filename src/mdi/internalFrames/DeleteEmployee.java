...
public class DeleteEmployee extends javax.swing.JInternalFrame {
    ...
    public DeleteEmployee(Client clients,String id) {
        this.client = clients;
        this.empID=id;
        initComponents();
    }
    ...
    private void jButtonSubmitActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(!jTextField1.getText().isEmpty()){
            client.sendOption(Options.DELETE_EMPLOYEE);
            client.sendOneRequest(jTextField1.getText());
            boolean del= (boolean) client.getResponse();
            if(del){
                jLabelResult.setText("Successfully");
            }else {
                jLabelResult.setText("Unsuccessfully");
            }
        }else {
