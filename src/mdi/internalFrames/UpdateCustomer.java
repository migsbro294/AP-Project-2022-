...
public class UpdateCustomer extends javax.swing.JInternalFrame {
    ...
    String empID="";
    public UpdateCustomer(Client clients,String id) {
        this.client = clients;
        this.empID=id;
        initComponents();
    }
    ...
    private void jButtonSubmitActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(!(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField5.getText().isEmpty() ||jTextField8.getText().isEmpty() ||jTextField9.getText().isEmpty() )){
