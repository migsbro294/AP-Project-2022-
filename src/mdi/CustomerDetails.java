...
public class CustomerDetails extends javax.swing.JFrame {
    ...
    public CustomerDetails(Client clients,String id) {
        this.client = clients;
        this.custID=id;
        initComponents();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(!(jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField5.getText().isEmpty() || jTextField8.getText().isEmpty() || jTextField9.getText().isEmpty() )){

            client.sendOption(Options.UPDATE_CUSTOMER);
            ...
            if(!(jTextField4.getText().isEmpty() && jTextField6.getText().isEmpty())){
                client.sendOption(Options.UPDATE_CUST_PASSWORD);
    ...
    private void loadPersonalDetails(String id){
        ...
        customer= (Customer) client.getResponse();

        String cid=customer.getCustomer_Id();
        String fname=customer.getFirstName();
        String lname=customer.getLastname();
        int number=customer.getContactNumber();
