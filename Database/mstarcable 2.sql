...
--
-- Host: localhost:8889
-- Generation Time: Mar 20, 2022 at 05:24 PM
...
--
-- Table structure for table `assigned_tech`
--

CREATE TABLE `assigned_tech` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `assigned_tech`
--
ALTER TABLE `assigned_tech`
  ADD PRIMARY KEY (`id`);
